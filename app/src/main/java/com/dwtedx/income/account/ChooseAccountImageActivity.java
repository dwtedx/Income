 ...
 * Description 帐户管理
 */
public class ChooseAccountImageActivity extends BaseActivity implements AppTitleBar.OnTitleClickListener {
    private AppTitleBar mAppTitleBar;
    private RecyclerView mRecyclerView;
    private ChooseAccountImageRecyclerViewAdatper mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ChooseAccountImageRecyclerViewAdatper(this);
