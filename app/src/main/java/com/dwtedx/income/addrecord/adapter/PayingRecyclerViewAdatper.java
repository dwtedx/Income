 ...
 */
public class PayingRecyclerViewAdatper extends RecyclerView.Adapter<PayingRecyclerViewAdatper.PayingRecyclerViewHolder> {
    ...
    public PayingRecyclerViewAdatper(Context context, List<DiType> diTypeList) {
        this.context = context;
        this.mDiTypeList = diTypeList;
    }

    @Override
    public PayingRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {//创建一个ViewHolder
        View itemView = LayoutInflater.from(context).inflate(R.layout.adapter_pay_recycler_item, viewGroup, false);//填充这个item布局
        PayingRecyclerViewHolder viewHolder = new PayingRecyclerViewHolder(itemView);//创建ViewHolder
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final PayingRecyclerViewHolder myViewHolder, int pos) {//绑定ViewHolder
    ...
    public class PayingRecyclerViewHolder extends RecyclerView.ViewHolder {
        TextView mTextView;
        ImageView mImageView;

        public PayingRecyclerViewHolder(View itemView) {
            super(itemView);
