...
public class AutoFooter extends BaseScrollFooter {
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        ...
        progress_auto = rootView.findViewById(com.liaoinstan.springview.R.id.progress_auto);
        lay_auto_bottom_line = rootView.findViewById(com.liaoinstan.springview.R.id.lay_auto_bottom_line);
        text_bottom = rootView.findViewById(com.liaoinstan.springview.R.id.text_bottom);
