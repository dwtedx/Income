...
import com.dwtedx.income.provider.IncomeTypeTipSharedPreferences;
 ...
 * Description 帐户管理
 */
public class IncomeTypeActivity extends BaseActivity implements AppTitleBar.OnTitleClickListener, MyItemTouchCallback.OnDragListener {
    private AppTitleBar mAppTitleBar;
    private RecyclerView mRecyclerView;
    private List<DiType> mDiTypeList;
    private IncomeProfileRecyclerViewAdatper mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new IncomeProfileRecyclerViewAdatper(this, mDiTypeList);
        ...
        mRecyclerView.addOnItemTouchListener(new OnRecyclerItemClickListener(mRecyclerView){
            ...
            public void onLongClick(RecyclerView.ViewHolder vh) {
                ...
                VibratorUtil.Vibrate(IncomeTypeActivity.this, 70);   //震动70ms
            }
            @Override
            public void onItemClick(RecyclerView.ViewHolder vh) {
                ...
                if (mDiType.getUserid() != 0) {
                    if (!isLogin()) {
                        startActivity(new Intent(IncomeTypeActivity.this, LoginV2Activity.class));
                        return;
                    }
                    Intent intent = new Intent(IncomeTypeActivity.this, AddAccountTypeActivity.class);
                    intent.putExtra("TYPEROLE",CommonConstants.INCOME_ROLE_INCOME);
        ...
        //是否有提示
        IncomeTypeTipSharedPreferences.init(this);
        if(IncomeTypeTipSharedPreferences.getIsTip()){
            ...
            mTipButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    IncomeTypeTipSharedPreferences.setIsTip(ApplicationData.mAppVersionCode);
                }
            });
        }
    ...
    protected void onResume() {
        super.onResume();
        mDiTypeList.clear();
        mDiTypeList.addAll(DITypeService.getInstance(this).findAll(CommonConstants.INCOME_ROLE_INCOME));
    ...
    private void showAdd() {
        ...
        Intent intent = new Intent(this, AddAccountTypeActivity.class);
        intent.putExtra("TYPEROLE",CommonConstants.INCOME_ROLE_INCOME);
    ...
    public void onFinishDrag() {
        for(int i = 0; i < mDiTypeList.size() ; i++){
            ...
            DITypeService.getInstance(IncomeTypeActivity.this).update(mDiTypeList.get(i));
        }
