...
public class SpecialOfferFragment extends BaseFragment implements SwipeRecyclerView.OnLoadListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.fragment_special_offer, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //getCouponItem(true, true);

    }

    private void getCouponItem(final boolean isShow, final boolean isClear) {
        ...
        TaobaoService.getInstance().getCouponItem(isClear ? 0 : mTaobaoItemInfoList.size(), CommonConstants.PAGE_LENGTH_NUMBER, dataVerHandler);
    }


    @Override
    public void onRefresh() {
        getCouponItem(false, true);
    }

    @Override
    public void onLoadMore() {
        getCouponItem(false, false);
    }
