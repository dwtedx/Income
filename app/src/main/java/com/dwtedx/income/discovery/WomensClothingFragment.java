...
public class WomensClothingFragment extends BaseFragment implements SwipeRecyclerView.OnLoadListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.fragment_womens_clothing, container, false);
    ...
    private void getWomensClothingItem(final boolean isShow, final boolean isClear) {
        ...
        TaobaoService.getInstance().getWomensClothingItem(isClear ? 0 : mTaobaoItemInfoList.size(), CommonConstants.PAGE_LENGTH_NUMBER, dataVerHandler);
    }


    @Override
    public void onRefresh() {
        getWomensClothingItem(false, true);
    }

    @Override
    public void onLoadMore() {
        getWomensClothingItem(false, false);
    }
