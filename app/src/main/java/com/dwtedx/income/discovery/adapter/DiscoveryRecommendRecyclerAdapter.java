 ...
 */
public class DiscoveryRecommendRecyclerAdapter extends RecyclerView.Adapter<DiscoveryRecommendRecyclerAdapter.ViewHolder> {
    ...
    public DiscoveryRecommendRecyclerAdapter(Context mContext, List<TaobaoSearchItemInfo> customerInfoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_discovery_recommend_item, parent, false);
