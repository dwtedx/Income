...
public class SnacksFragment extends BaseFragment implements SwipeRecyclerView.OnLoadListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.fragment_snacks, container, false);
    ...
    private void getTaobaoItem(final boolean isShow, final boolean isClear) {
        ...
        TaobaoService.getInstance().getSnacksItem(isClear ? 0 : mTaobaoItemInfoList.size(), CommonConstants.PAGE_LENGTH_NUMBER, dataVerHandler);
    }
