...
public class MotherBabyFragment extends BaseFragment implements SwipeRecyclerView.OnLoadListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.fragment_mother_baby, container, false);
    ...
    private void getTaobaoItem(final boolean isShow, final boolean isClear) {
        ...
        TaobaoService.getInstance().getMotherBabyItem(isClear ? 0 : mTaobaoItemInfoList.size(), CommonConstants.PAGE_LENGTH_NUMBER, dataVerHandler);
    }
