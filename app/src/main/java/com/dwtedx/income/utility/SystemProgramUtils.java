...
public class SystemProgramUtils {
    ...
    public static void startCamera(Activity activity, File outputFile){
    ...
    public static void startPhotoZoom(Activity activity, Uri uri, File outputFile) {
    ...
    public static void startPhotoZoomCard(Activity activity, Uri uri, File outputFile) {
        Intent intent = new Intent("com.android.camera.action.CROP");
        FileProviderUtils.setIntentDataAndType(activity, intent, "image/*", uri, true);
        intent.putExtra("crop", "true");
    ...
    //兼容Fragment///////兼容Fragment///////兼容Fragment///////兼容Fragment///////兼容Fragment///////兼容Fragment///////兼容Fragment/////
    public static Intent startCameraIntent(Activity activity, File outputFile){
        Intent intent = new Intent();
        intent.setAction("android.media.action.IMAGE_CAPTURE");
        intent.addCategory("android.intent.category.DEFAULT");
        Uri uri = FileProviderUtils.uriFromFile(activity, outputFile);
    ...
    public static Intent startPictureIntent(Activity activity){
        Intent intent = new Intent();
        intent.setType("image/*");
        intent.setAction("android.intent.action.PICK");
        intent.addCategory("android.intent.category.DEFAULT");
    ...
    public static Intent startPhotoZoomIntent(Activity activity, Uri uri, File outputFile) {
        Intent intent = new Intent("com.android.camera.action.CROP");
        FileProviderUtils.setIntentDataAndType(activity, intent, "image/*", uri, true);
        intent.putExtra("crop", "true");
        intent.putExtra("aspectX", 1);
