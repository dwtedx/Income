...
public class TaobaoSearchItemInfo {
    ...
    private TaobaoSmallInagesInfo small_images;
    ...
    public TaobaoSmallInagesInfo getSmall_images() {
        return small_images;
    }

    public void setSmall_images(TaobaoSmallInagesInfo small_images) {
