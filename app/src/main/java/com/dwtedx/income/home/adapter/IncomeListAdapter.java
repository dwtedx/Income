...
/**
 * @Created by dwtedx(qinyl)(http://dwtedx.com) on 15/12/21 下午1:32.
 * @Company 路之遥网络科技有限公司
 * @Description 首页车辆适配器
 */
public class IncomeListAdapter extends BaseAdapter {
     ...
     * @param
     */
    public IncomeListAdapter(Context mContext, List<DiIncome> mCarsList) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            mHolder = new Holder();
            convertView = mInflater.inflate(R.layout.adapter_income_list_item, null);
            ...
            if(mDiIncome.getRole() != CommonConstants.INCOME_ROLE_START) {
                ...
                switch (mDiIncome.getRole()) {
                    case CommonConstants.INCOME_ROLE_INCOME:
                        ...
                        mHolder.money_textview.setTextColor(Color.parseColor("#00aaee"));
                    ...
                    case CommonConstants.INCOME_ROLE_PAYING:
                        ...
                        mHolder.money_textview.setTextColor(Color.parseColor("#333333"));
                        if(null == mDiIncome.getIcon()){
