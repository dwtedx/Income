...
public class DiAccountAdapter extends ArrayAdapter<DiAccount> {

    private Context mContext;
    private final LayoutInflater layoutInflater;

    public DiAccountAdapter(Context context, List<DiAccount> mDiAccountItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.adapter_account_item, parent, false);
